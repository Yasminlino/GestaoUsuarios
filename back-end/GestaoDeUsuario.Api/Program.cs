...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "GestaoDeUsuario API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "GestaoDeUsuario API v1");
    });
}
